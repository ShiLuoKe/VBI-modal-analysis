...
This code was developed by Shi LuoKe (Chongqing University, CQU, 重庆大学) during a visiting PhD period at the Norwegian University of Science and Technology (NTNU, Norges teknisk-naturvitenskapelige universitet). The program is based on a conventional VBI code originally provided by Xu Hao (CQU), and the theoretical interpretation of the formulation was completed under the guidance of the author's supervisor, Prof. Y.B. Yang (CQU). The author would like to express special gratitude to Daniel Cantero for his hospitality, support, and valuable suggestions during the visit at NTNU.
